...
EXP="${EXP_NAME:-cmllm_lisa_plus_mr_ref_v1_$(date +%Y%m%d_%H%M%S)}"
OUT_ROOT="${OUT_ROOT:-/home/wjq/cmllm/outputs/lisa_finetune}"
LOG="${LOG:-/home/wjq/cmllm/outputs/lisa_finetune_mr_ref_v1.log}"
ENV_OUT="${ENV_OUT:-/home/wjq/cmllm/outputs/lisa_finetune_mr_ref_v1_current_run.env}"
EPOCHS="${EPOCHS:-1}"
...
/home/wjq/venvs/rex/bin/deepspeed --include "localhost:${DS_GPU_INDEX}" --master_port="${MASTER_PORT:-29581}" train_ds.py \
