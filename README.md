...
[Cycle013](research_log/CYCLE013.md) 修正初始化后完成唯一一次12,577参数MG-DRA训练。退化mIoU0.6911→0.7068、CMSA29/50→30/50，clean保持；未达到+0.02及至少3组恢复的门槛。按约定结束局部聚焦架构搜索，转向identity-memory与退化基线证据。
