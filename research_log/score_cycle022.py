...
work = root / 'research_log/cycle022'
out = work / 'scoring'
...
for method in ['cma', 'segllm']:
    folder = root / 'outputs/cycle022' / method
...
pairs = {r['pair_id']: r for r in map(json.loads, (root / 'shared/data/cycle022/helmet_miner_pairs_restored.jsonl').read_text().splitlines())}
summaries, reports = {}, {}
